...
function NavDropdownItem({ item, parentKey }: { item: NavChild; parentKey: string }) {
        ...
        <ul className="dropdown-menu">
          {item.children?.map((child) => (
            <li key={child.label} className="nav-item">
              <Link href={child.href} className={cn("nav-link", child.active && "active")}>
                {child.label}
              </Link>
            </li>
          ))}
  ...
  return (
    <li className="nav-item">
      <Link href={item.href} className={cn("nav-link", item.active && "active")}>
        {item.label}
      </Link>
    </li>
  );
                ...
                {MAIN_NAV_ITEMS.map((item) => (
                  ...
                  >
                    {item.href ? (
                      <Link
                        href={item.href}
                        className={cn("nav-link dropdown-toggle", item.active && "active")}
                      >
                        {item.label}
                      </Link>
                    ) : (
